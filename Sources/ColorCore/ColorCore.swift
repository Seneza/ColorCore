...
public class ColorCore {
    ...
    /// - Parameters:
    ///   - hexString: A 6-digit hexacdecimal string. Use 6 digits rather than 8, and add the accompanying alpha value in the second parameter
    ...
    /// experimental color
    public static var colorCore: UIColor {
        return self.colorFromHexString("008976")
    }
}
